---
name: typescript
description: Guides spnd TypeScript and JavaScript work. Use before reading or editing .ts, .tsx, .js, or .jsx files, including package launchers, Node tests, schemas, mocks, and typed fixtures.
paths:
  - '**/*.ts'
  - '**/*.tsx'
  - '**/*.js'
...
Runtime CLI behavior belongs in Rust under `rust/crates/spnd`. Do not add new
...
Use `testing` and read `testing/references/node-test.md` for spnd-specific
